-- ============================================================
-- Layer 1: Team xG vs Actual Goals — Season Summary
-- ============================================================
-- SQL concepts: multi-table JOIN, GROUP BY, SUM, ROUND,
--               NULLIF (division safety), ORDER BY


-- psql -U pl_xg_user -d pl_xg -h localhost \
--     -f sql/queries/team_xg_summary.sql
SELECT
    t.team_name,
    s.season_name,
